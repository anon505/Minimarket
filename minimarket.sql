...
INSERT IGNORE INTO `barang` (`id_barang`, `id_suplier`, `id_satuan`, `barcode`, `nama_barang`, `harga_beli`, `ppn`, `discount`, `harga_beli_netto`, `stok_display`, `stok_gudang`, `harga_jual1`, `harga_jual2`, `harga_jual3`, `harga_jual4`, `qty2`, `qty3`, `qty4`) VALUES
	...
	(12, 1, 1, '445566', 'barang baru dateng', 1000, 0, 0, 1000, 0, 101, 5000, 4000, 3000, 2000, 3, 4, 3),
...
CREATE TABLE `ds_report_penjualan` (
	...
	`kode_transaksi` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
...
-- Dumping data for table minimarket.mutasi: ~0 rows (approximately)
...
-- Dumping data for table minimarket.transaksi_detail: ~0 rows (approximately)
