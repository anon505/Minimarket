...
Public Class retur_suplier_report
    ...
    Public Sub view(ByVal isFilter As Boolean)
        ...
        If isFilter Then
            ...
            query = "select faktur_retur,nama_kasir,nama_barang,nama_suplier,qty,created_at from ds_retur_suplier where created_at >= '" & startTime & "' AND created_at <= '" & endTime & "' order by created_at desc"
        Else
            query = "select faktur_retur,nama_kasir,nama_barang,nama_suplier,qty,created_at from ds_retur_suplier order by created_at desc"
        End If
