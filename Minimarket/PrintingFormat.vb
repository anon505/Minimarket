...
Public Class PrintingFormat
    ...
    Public ReadOnly Property FntTitle() As Font
        Get
            Return New Font("Monospace", 12, FontStyle.Bold, GraphicsUnit.Point)
        End Get
    End Property

    Public ReadOnly Property FntTableHeader() As Font
        Get
            Return New Font("Monospace", 10, FontStyle.Bold, GraphicsUnit.Point)
        End Get
    End Property

    Public ReadOnly Property FntTableCell() As Font
        Get
            Return New Font("Monospace", 10, FontStyle.Regular, GraphicsUnit.Point)
        End Get
    End Property
